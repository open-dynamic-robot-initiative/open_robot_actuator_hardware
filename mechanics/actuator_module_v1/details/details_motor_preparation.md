...
* stator and rotor are separated - the motor shaft is removed from the rotor
* the bore diameter of the rotor is increased to fit the custom motor shaft
* extension wires are soldered to the motor phase wires
---
